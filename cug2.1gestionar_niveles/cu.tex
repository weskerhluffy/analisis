...
%  
	...
	\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] Selecciona la opcion de \textit{Gestión de Niveles} del \IUref{IUMenuGerente}{Menú de Gerente}.
		\UCpaso Busca todos los niveles registrados.\Trayref{A}.  \label{paso:CUG2.1buscarNiveles}
		\UCpaso Muestra en la pantalla \IUref{IUGestNiveles}{Gestionar Nivel} los datos de los niveles con campo para buscar y las opciones para Agregar, Modificar o Eliminar.\UCExtensionPoint{CUG2.1.1}{Agregar Nivel} \UCExtensionPoint{CUG2.1.2}{Modificar Nivel} \UCExtensionPoint{CUG2.1.3}{Eliminar Nivel}
	\end{UCtrayectoria}
...
%--------- Agregar Nivel
	...
	\begin{UCtrayectoria}{Principal}
			\UCpaso[\UCactor] Oprime el botón \IUbutton{Agregar Nivel} de la pantalla \IUref{IUGestNiveles}{Gestionar Niveles}.
	...
	\begin{UCtrayectoriaA}{B}{Datos del Nivel Incompletos}{Algunos campos del Nivel no han sido capturados.}
			...
			\UCpaso Continúa en environment. el paso \ref{paso:CUG2.1.1IngresaDatosNivel} del \UCref{CUG2.1.1}.
	\end{UCtrayectoriaA}
...
%--------- Modificar Nivel
	\begin{UseCase}{CUG2.1.2}{Modificar Nivel}{El Gerente selecciona un Nivel registrado para modificar sus datos.}
			\UCitem{Versión}{2.0}
			\UCitem{Actor(es)}{Gerente.}
			\UCitem{Propósito}{Modificar los datos de un Nivel y acstatus tualizar el registro en el sistema.}
	...
	\begin{UCtrayectoria}{Principal}			
			\UCpaso[\UCactor] Oprime el botón \IUbutton{\includegraphics[scale=0.1]{images/icons/editar.png}} del nivel que desea modificar en la pantalla \IUref{IUGestNiveles}{Gestionar Nivel}.
			\UCpaso Muestra la pantalla \IUref{IUModificarNivel}{Editar Nivel} con los datos del Nivel seleccionado y sujeto a la regla de negocio \BRref{RN38}.
	...
	\begin{UCtrayectoriaA}{B}{Datos del Nivel Incompletos}{Algunos campos del Nivel no han sido capturados.}
			\UCpaso Muestra el mensaje (MSG-1).\ref{MSG1}
			\UCpaso Continúa en el paso \ref{paso:CUG2.1.2ingresaDatosNivel} del \UCref{CUG2.1.2}.
	\end{UCtrayectoriaA}
...
%--------- Eliminar Nivel
	...
	\begin{UCtrayectoria}{Principal}
			\UCpaso[\UCactor] Oprime el botón \IUbutton{\includegraphics[scale=0.1]{images/icons/eliminar.png}} del nivel que desea eliminar en la pantalla \IUref{IUGestNiveles}{Gestionar Nivel}.
			\UCpaso Verifica que se cumpla el primer aspecto de la regla de negocio \BRref{RN39}.\Trayref{A}
			\UCpaso Verifica que se cumpla el segundo aspecto de la regla de negocio \BRref{RN39}. \Trayref{B}
