...
% Resumen: Describe brevemente lo que hace el CU
	...
	\begin{UseCase}{CU2.1.2.1}{Revisar reportes de avances de una Acción}{Permite visualizar reportes de avance registrados de la acción.}
		...
		\UCitem{Actor(es)}{Gerente, Coordinador}
	...
	\begin{UCtrayectoria}{Principal}
		...
		\UCpaso Busca todos los indicadores registrados para la acción seleccionada.\Trayref{A}
		\UCpaso Muestra en la pantalla \IUref{IURevisarReportesAvanceGerente}{Reportes de Avance de Proyecto, perfil Gerente} la descripción, meta, peso, avance y fecha de último reporte de todos los indicadores encontrados. \Trayref{B} \ref{dd:DatosIndicador}
	...
	\end{UCtrayectoria}
		...
		\begin{UCtrayectoriaA}{B}{El perfil del actor es Coordinador}{El actor que se ha iniciado el caso de uso es un Coordinador}
			\UCpaso Muestra la opción \IUbutton{Subir evidencia}.  \UCExtensionPoint{CUC7}{Subir Evidencia}
		\end{UCtrayectoriaA}
