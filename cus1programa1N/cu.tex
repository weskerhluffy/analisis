	\begin{UseCase}{CUS1}{Gestionar Programas}{Gestiona un catálogo en el que se puede realizar Altas, Bajas y Cambios de los Programas.}
		\UCitem{Versión}{1.0}
		...
		\UCitem{Resumen}{Se muestran los Programas registrados con la posibilidad de agregar, modificar y eliminar un Programa.}
	...
	\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] Oprime el bot\'on \IUbutton{Gestionar Programas} en el men\'u \IUref{IUMenuDirector}{Menú para Secretarios.}
		\UCpaso Busca los Programas registrados.\label{paso:CUS1buscarProgramas1N}\Trayref{A}
		\UCpaso Muestra la pantalla \IUref{IUGestProgramas1N}{Gestionar Programas1N} donde se muestran los datos de los Programas1N registrados y las opciones para Agregar, Modificar y Eliminar Programas.\UCExtensionPoint{CUS1.1}{Agregar Programa} \UCExtensionPoint{CUS1.2}{Modificar Programa} \UCExtensionPoint{CUS1.3}{Eliminar Programa}
	\end{UCtrayectoria}
...
%--------- Agregar Programa1N
	\begin{UseCase}{CUS1.1}{Agregar Programa}{El usuario registra un nuevo Programa con sus respectivos datos.}
		\UCitem{Versión}{1.0}
		\UCitem{Actor(es)}{Secretario.}
		...
		\UCitem{Referencias}{SIDAM-BESP-P0-Especificación de Catálogos}
		\UCitem{Tipo}{Secundario. Viene del \UCref{CUS1}}
		\UCitem{Módulo}{Secretaría}
	\end{UseCase}

	\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] Oprime el bot\'on \IUbutton{\includegraphics[scale=0.1]{images/icons/agregar.png}} en la p\'agina \IUref{IUGestProgramas1N}{Gestionar Programas}.
		...
		\UCpaso Verifica si un Programa ha sido marcado como programa sectorial según la regla de negocio \BRref{42}.
		...
		\UCpaso Contin\'ua en el paso \ref{paso:CUS1buscarProgramas1N} del \UCref{CUS1}.
	\end{UCtrayectoria}
	...
	\begin{UCtrayectoriaA}{A}{Programa sectorial no marcado}{Ning\'un Programa ha sido marcado como programa sectorial.}
		...
		\UCpaso Contin\'ua en el paso \ref{paso:CUS1.1ingresaDatosPrograma1N} del \UCref{CUS1}.
	\end{UCtrayectoriaA}
	...
	\begin{UCtrayectoriaA}{C}{Datos incompletos}{Algunos datos del Programa no han sido capturados.}
			...
			\UCpaso Contin\'ua en el paso \ref{paso:CUS1.1ingresaDatosPrograma1N} del \UCref{CUS1.1}.
	\end{UCtrayectoriaA}
...
%--------- Modificar Programa1N
	\begin{UseCase}{CUS1.2}{ModificarPrograma1N}{El usuario selecciona un Programa registrado para modificar sus datos.}
			...
			\UCitem{Tipo}{Secundario. Viene del \UCref{CUS1}}
			\UCitem{M\'odulo}{Secretaría}
	\end{UseCase}

	\begin{UCtrayectoria}{Principal}
                       \UCpaso[\UCactor] Oprime el bot\'on \IUbutton{\includegraphics[scale=0.1]{images/icons/editar.png}} del registro seleccionado de la pantalla \IUref{IUGestProgramas1N}{Gestionar Programas}.
	...
	\end{UCtrayectoria}
		...
		\begin{UCtrayectoriaA}{A}{Programa marcado como programa sectorial}{El Programa1N seleccionado est\'a marcado como programa sectorial.}
			...
			\UCpaso Contin\'ua en el paso \ref{paso:CUS1.2ingresaDatosPrograma1N} del \UCref{CUS1}.
		\end{UCtrayectoriaA}
...
%--------- Eliminar Programa1N
	\begin{UseCase}{CUS1.3}{Eliminar Programa}{El usuario elimina un Programa registrado.}
			...
			\UCitem{Resumen}{El sistema muestra los Programas registrados y permite seleccionar un Programa1N para eliminarlo.}
	...
	\begin{UCtrayectoria}{Principal}
                        \UCpaso[\UCactor] Oprime el bot\'on \IUbutton{\includegraphics[scale=0.1]{images/icons/eliminar.png}} del registro seleccionado de la pantalla \IUref{IUGestProgramas1N}{Gestionar Programas}.
