	\begin{UseCase}{CUC2.2.1}{Gestionar Acciones}{Consiste en gestionar un catálogo en el cuál se pueden realizar Altas, Bajas y Cambios de las Acciones.}
		\UCitem{Versión}{2}
		...
		\UCitem{Precondiciones}{
			\begin{itemize}
			 	\item Haber pasado por el \UCref{CUC2}.
			\end{itemize}
		}
		\UCitem{Postcondiciones}{Ninguna.}
		%\UCitem{Autor}{Hermosillo García Karen Adriana}
		\UCitem{Referencias}{Ninguna.}
		\UCitem{Tipo}{Secundario, viene del \UCref{CUC2}}
	...
	\begin{UCtrayectoria}{Principal}
		...
		\UCpaso Muestra en la pantalla \IUref{IUGestAcciones}{Gestionar Acciones} los nombres de las acciones registradas en el proyecto y su duración en el diagrama de gantt.
		\UCpaso Muestra las opciones de agregar, eliminar y modificar acciones, asi como la opción de gestión de indicadores.\UCExtensionPoint{CUC2.2.1.1}{Agregar Acción}, \UCExtensionPoint{CUC2.2.1.2}{Modificar Acción}, \UCExtensionPoint{CUC2.2.1.3}{Eliminar Acción}, \UCExtensionPoint{CUC2.2.1.4}{Gestión de indicadores Fisicos}.
	\end{UCtrayectoria}
...
%--------- Agregar Acción
	\begin{UseCase}{CUC2.2.1.1}{Agregar Acción}{El Coordinador registra una nueva acción a un Proyecto.}
			...
			\UCitem{Entradas}{Datos generales de la acción y periodo \ref{dd:accion}.}
	...
	\begin{UCtrayectoria}{Principal}
			\UCpaso[\UCactor] Selecciona la opción \IUbutton{\includegraphics[scale=0.15]{images/icons/agregar.png}} de la pantalla \IUref{IUPlaneacion}{Planeación de proyecto}. %TODO Cambiar pantalla de gestionar acciones por planeación
			...
			\UCpaso Continúa en el paso \ref{paso:CUC2.planeacion} del \UCref{CUC2}.
	\end{UCtrayectoria}
...
%--------- Modificar Acción
	\begin{UseCase}{CUC2.2.1.2}{Modificar acción}{El sistema despliega los Datos de las acciones registradas y permite seleccionar una acción por el Coordinador para modificar sus datos, guardando los cambios y actualizándolos en el sistema.}
			...
			\UCitem{Resumen}{El Coordinador selecciona una acción registrada para modificar sus datos.}
	...
	\begin{UCtrayectoria}{Principal}
			\UCpaso[\UCactor] Selecciona la fila del registro de la acción que desea modificar en la pantalla \IUref{IUPlaneacion}{Planeación de proyecto}.	
			\UCpaso[\UCactor] Presiona el botón \IUbutton{\includegraphics[scale=0.1]{images/icons/Modificar.png}}. 
...
%--------- Eliminar Acción
	\begin{UseCase}{CUC2.2.1.3}{Eliminar Acción}{El sistema despliega los Datos de las acciones registradas y permite al Coordinador seleccionar una  acción para eliminarla.}
			...
			\UCitem{Resumen}{El Coordinador elimina una acción perteneciente a un Proyecto.}
			\UCitem{Entradas}{Ninguna}
	...
	\begin{UCtrayectoria}{Principal}
			\UCpaso[\UCactor] Selecciona la fila del registro que desea eliminar en la pantalla \IUref{IUPlaneacion}{Planeación de proyecto}.
			\UCpaso[\UCactor] Presiona el boton \IUbutton{\includegraphics[scale=0.9]{images/icons/elim.png}}.
