...
\begin{itemize}
 \item \IUbutton{Atender}: El sistema muestra actualizara la pantalla \IUref{IUConsultaBitacoraGerente}{Consulta bitacora, vista del gerente.} para poder agregar las instrucciones para la solución de la restricción.
 \item \IUbutton{Turnar}: El sistema muestra actualizara la pantalla \IUref{IUConsultaBitacoraGerente}{Consulta bitacora, vista del gerente.} para poder agregar la descripción de la restricción y poder turnarla.
 \item \IUbutton{Atender Restricción}: El sistema muestra actualizara la pantalla \IUref{IUConsultaBitacoraGerenteAtenderRestriccion}{Atiende restricción en la bitacora, vista del gerente.} para registrar las instrucciones.
 \item \IUbutton{Habilitar Edición}: El sistema actualizara la pantalla \IUref{IUConsultaBitacoraGerenteAtenderRestriccion}{Atiende restricción en la bitacora, vista del gerente.} para poder habilitar la edición del proyecto.
 \item \IUbutton{Turnar Restricción}: El sistema muestra actualizara la pantalla \IUref{IUConsultaBitacoraGerenteTurnarRestriccion}{Turnar restricción en la bitacora, vista del gerente.} para registrar la descripción de la restriccion y poner pendiente la restricción.
 \item \IUbutton{Cancelar}: El sistema muestra actualizara las pantallas \IUref{IUConsultaBitacoraGerenteAtenderRestriccion}{Atiende restricción en la bitacora, vista del gerente.} / \IUref{IUConsultaBitacoraGerenteTurnarRestriccion}{Turnar restricción en la bitacora, vista del gerente.} para eliminar los campos de atender/turnar y no registrar cualquiera de las dos acciones.
\end{itemize}
