	...
	\begin{UseCase}{CUC2.2.1.4}{Gestionar Indicadores Físicos}{Administra un catálogo en el que se puede realizar Altas, Bajas y Cambios de Indicadores Físicos pertenecientes a una \textit{Acción}.}
		...
		\UCitem{Precondiciones}{Que haya almenos una acción en el proyecto seleccionado, este proyecto debe estar en estado de edición.}
		\UCitem{Postcondiciones}{Ninguna.}
		\UCitem{Autor}{Pérez Domínguez Alberto Michel}
		\UCitem{Referencias}{SIDAM-BESP-P2}
		\UCitem{Tipo}{Secundario, viene de \UCref{CUC2.2.1}.}
	...
	\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] Selecciona una Acción de la pantalla \IUref{IUModificarProyecto}{Editar Proyecto}.
		\UCpaso[\UCactor] Oprime el botón \IUbutton{Indicadores}.
		\UCpaso Busca los Indicadores registrados de la Acción seleccionada.\Trayref{A}\label{paso:CUC14BuscarIndicadores}
		\UCpaso Muestra la pantalla \IUref{IUEvaluarAccion}{Gestión de Indicadores} donde se despliegan los de datos de los Indicadores registrados y las opciones de Agregar, Modificar y Eliminar un Indicador.\UCExtensionPoint{CUC2.2.1.4.1}{Agregar Indicador} \UCExtensionPoint{CUC2.2.1.4.2}{Modificar Indicador} \UCExtensionPoint{CUC2.2.1.4.3}{Eliminar Indicador}
	\end{UCtrayectoria}
...
%--------- Agregar Indicadores
	\begin{UseCase}{CUC2.2.1.4.1}{Agregar Indicador Físico}{El Coordinador registra un nuevo Indicador para la Acción.}
			\UCitem{Versión}{1.0}
			\UCitem{Actor(es)}{Coordinador.}
	...
	\begin{UCtrayectoria}{Principal}
			\UCpaso[\UCactor] Oprime el botón \IUbutton{\includegraphics[scale=0.1]{images/icons/agregar.png}} de la pantalla \IUref{IUEvaluarAccion}{Gestión de Indicadores}.
			\UCpaso Busca los Tipos de Unidades registradas.
			\UCpaso Muestra la pantalla \IUref{IUAgregarIndicador}{Agregar Indicador}.
...
%--------- Modificar Indicadores
	\begin{UseCase}{CUC2.2.1.4.2}{Modificar Indicador Físico}{El Coordinador modifica el registro de un Indicador perteneciente a la Acción.}
			\UCitem{Versión}{1.0}
			\UCitem{Actor(es)}{Coordinador.}
...
% 
	\begin{UCtrayectoria}{Principal}
			\UCpaso[\UCactor] Selecciona un Indicador de la pantalla \IUref{IUEvaluarAccion}{Gestión de Indicadores}.
			\UCpaso[\UCactor] Oprime el botón \IUbutton{\includegraphics[scale=0.1]{images/icons/Modificar.png}}.
			\UCpaso Muestra la pantalla \IUref{IUModificarIndicador}{Modificar Indicador} con los datos actuales del Indicador seleccionado.
...
%--------- Eliminar Indicadores
	...
	\begin{UCtrayectoria}{Principal}
			\UCpaso [\UCactor] Selecciona el Indicador a eliminar de la pantalla \IUref{IUGestIndicadores}{Gestión de Indicadores}.
