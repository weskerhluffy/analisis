	\begin{UseCase}{CUC4}{Dictaminar Presupuesto}{El usuario determina el monto que se aprueba de un presupuesto registrado.}
			\UCitem{Versión}{3.0}
	...
	\begin{UCtrayectoria}{Principal}
			\UCpaso[\UCactor] Oprime el botón \IUbutton{Aprobar presupuesto}  de la pantalla \IUref{IURevisarProyectos}{Revisar Proyecto}.
	...
	\begin{UCtrayectoriaA}{A}{Cancelar operación}{El usuario abandona el Caso de Uso.}
			...
			\UCpaso Continúa en el paso \ref{paso:CU2.1.2buscarProyectos} del \UCref{CU2.1.2}.
	\end{UCtrayectoriaA}
