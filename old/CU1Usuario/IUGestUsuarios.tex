...
\begin{itemize}
 ...
 \item \IUbutton{\includegraphics[scale=0.1]{images/icons/editar.png}} Permite realizar modificaciones a un Usuario selecionado.\IUref{IUModificarUsuario}{Modificar Usuario}.
 \item \IUbutton{\includegraphics[scale=0.1]{images/icons/eliminar.png}} Elimina el registro de un Usuario del sistema siempre y cuando no tenga proyectos asociados.\IUref{IUEliminarUsuario}{Eliminar Usuario.}
 \item \IUbutton{\includegraphics[scale=0.1]{images/icons/ver.png}} Muestra los datos completos del Usuario. \IUref{IUVisualizarUsuario}{Visualizar Usuario.}
