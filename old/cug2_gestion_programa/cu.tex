	...
	\begin{UseCase}{CUG2}{Gestión del programa}{Administra la estructura y niveles del programa con las opciones de agregar, modificar y eliminar.}
		...
		posibilidad de agregar, modificar y eliminar elementos con base en los niveles definidos. También se muestran los niveles para su gestión.}
		\UCitem{Entradas}{No.}
	...
	\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] Selecciona la opción \IUbutton{Gestión del programa} en el menú \IUref{IUMenuGerente}{Menú de gerente} o \IUbutton{Editar} de la pantalla \IUref{IURevisarPrograma}{Gestión del Programa}.
		...
		\UCpaso Muestra la pantalla \IUref{IUEstructura}{Gestión del programa} con los nombres de los niveles ordenados por posición y las opciones para Agregar, Modificar o Eliminar un Nivel.\UCExtensionPoint{CUG2.1.1}{Agregar Nivel} \UCExtensionPoint{CUG2.1.2}{Modificar Nivel} \UCExtensionPoint{CUG2.1.3}{Eliminar Nivel} \label{paso:CUG2niveles}.
	\end{UCtrayectoria}
	...
	\begin{UCtrayectoriaA}{B}{Mostrar datos del elemento.}{El usuario puede seleccionar un elemento del diagrama de gantt para que el sistema muestre los datos del mismo.}
			...
			\UCpaso Muestra los datos del elemento seleccionado. Puntos de extension 1:\UCref{CUG2.2} 2:\UCref{CUG2.3} 3:\UCref{CUG2.4}.
			\UCpaso Regresa al paso \ref{paso:CUG2gantt} de \UCref{CUG2}. 
	\end{UCtrayectoriaA}
...
%--------- Eliminar Unidad
	\begin{UseCase}{CUG2.3}{Eliminar estructura}{El usuario elimina una estructura registrada.}
			\UCitem{Versión}{1.0}
			\UCitem{Actor(es)}{Gerente.}
