      \begin{UseCase}{CUA2}{Gestionar Contactos}{Cada usuario registrado que se encuentra en el sistema cuenta con un determinado número de Contactos,para éste catálogo de contactos contamos con un mecanismo que nos ayuda a realizar altas, bajas y cambios en cada uno de dichos contactos que tiene asignado el usuario.Este proceso es aplicable para cada usuario registrado en el sistema.}
		\UCitem{Versión}{2.0}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] Oprime el botón \IUbutton{Gestión Usuarios} de la pantalla
		\IUref{IUMenuAdministrador}{Menú del Administrador}.
		\UCpaso Muestra la pantalla \IUref{IUGestUsuarios}{Gestionar usuario}.
		\UCpaso[\UCactor] Oprime el botón \IUbutton{\includegraphics[scale=0.1]{images/icons/editar.png}} del algùn Usuario de la pantalla \IUref{IUGestUsuarios}{Gestionar Usuarios.}.
...
%--------- Agregar Contacto
	\begin{UseCase}{CUA2.1}{Agregar Contacto}{El administrador decide agregar un nuevo Contacto de acuerdo al llenado de sus datos correspondientes, posteriormente se actualiza el sistema con la información del nuevo contacto registrado.}
			\UCitem{Versión}{2.0}
			\UCitem{Actor(es)}{Administrador}
	...
	\begin{UCtrayectoria}{Principal}
			\UCpaso[\UCactor] Oprime el botón \IUbutton{Agregar Contacto} en la página \IUref{IUGesContactos}{Gestionar Contactos}.
...
%--------- Modificar Contacto
	\begin{UseCase}{CUA2.2}{Modificar Contacto}{El Administrador accede a los datos del Contacto de un Usuario registrado y realiza los cambios necesarios,se actualizan los datos del contacto registrado en el sistema.}
			\UCitem{Versión}{2.0}
			\UCitem{Actor(es)}{Administrador}
	...
	\begin{UCtrayectoria}{Principal}
			\UCpaso[\UCactor] Oprime el botón \IUbutton{\includegraphics[scale=0.2]{images/icons/Modify.jpg}} en la pantalla \IUref{IUGesContactos}{Gestionar Contactos}.
...
%--------- Eliminar Contacto
	\begin{UseCase}{CUA2.3}{Eliminar Contacto }{El Administrador decide eliminar el/los Contactos de un Usuario registrado.}
			\UCitem{Versión}{2.0}
			\UCitem{Actor(es)}{Administrador}
	...
	\begin{UCtrayectoria}{Principal}
			\UCpaso[\UCactor] Oprime el botón \IUbutton{\includegraphics[scale=0.2]{images/icons/eliminar.png}} en la pantalla \IUref{IUGesContactos}{Gestionar Contactos}.
